...
Source Map 非常强大，不仅在应用于日常开发，还可以做更多的事情，如 性能异常监控平台 。比如FunDebug[23]这个网站就是通过 Source Map 还原生产环境中的压缩代码，提供完整的堆栈信息，准确定位出错误源码，帮助用户快速修复 Bug ，像这样的案例还有许多。
