...
 ​![image.png](https://img-blog.csdnimg.cn/20210325110514178.png?x-oss-process=image/watermark,type_ZmFuZ3poZW5naGVpdGk,shadow_10,text_aHR0cHM6Ly9ibG9nLmNzZG4ubmV0L2VsaWppcA==,size_16,color_FFFFFF,t_70)
...
<script > import KForm from "./KForm";
export default {
        components:
        {
            KForm,
